...
class MenuthemeController extends ControllerAbstract {
    ...
    protected $table = \SIGA\Auth\V1\Tables\MenuthemeTable::class;
    protected $TableModel = \SIGA\Auth\V1\Api\Models\Menutheme::class;
    protected $model = \SIGA\Auth\V1\Models\Menutheme::class;
