...
class ResourceController extends ControllerAbstract {
    ...
    protected $table = \SIGA\Auth\V1\Tables\ResourceTable::class;
    protected $TableModel = \SIGA\Auth\V1\Api\Models\Resource::class;
    protected $model = \SIGA\Auth\V1\Models\Resource::class;
