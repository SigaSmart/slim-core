...
class SessionMiddleware {
    ...
    protected function startSession() {
        ...
        session_set_cookie_params(
                $settings['lifetime'], $settings['path'], $settings['domain'], $settings['secure'], $settings['httponly']
        );
        ...
        if ($inactive) {
            ...
            if ($settings['autorefresh'] && $cookie) {
                setcookie(
                        $name, $cookie, time() + $settings['lifetime'], $settings['path'], $settings['domain'], $settings['secure'], $settings['httponly']
                );
            }
        }
